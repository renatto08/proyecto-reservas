<div class="container">
    <div class="row">
        <div class="col-12 col-lg-3 order-1 order-lg-0">
            <div class="block">
                <aside class="sidebar">
                    @include('theme_default.partials._sidebar')
                </aside>
            </div>
        </div>
                ...
                <div class="products-view">
                    <div class="products-view__options view-options">
                        <div class="view-options__layout">
                            <a href="{{route('shop.shop',['code'=>$shop->code,'view_list'=>false])}}" class="view-options__layout-button ">
                                <svg width="14px" height="14px">
                                    <use xlink:href="{{shop_asset($shop->theme,'images/sprite.svg#grid-14')}}"></use>
                                </svg>
                            </a>
                            <a href="{{route('shop.shop',['code'=>$shop->code,'view_list'=>true])}}" class="view-options__layout-button  view-options__layout-button--active ">
                                <svg width="14px" height="14px">
                            ...
                            <div class="products-list__item">
                                <div class="product-card product-card--layout--list">
                                    ...
                                    <div class="product-card__image">
                                        ...
                                        @else
                                            <a href="{{route('shop.product',['code'=>$shop->code,'product_id' => $prod->id,'slug'=>$prod->slug])}}"><img srcset="{{asset('themes/default/images/products/product1-1.jpg')}} 1x, {{asset('themes/default/images/products/product1-1@2x.jpg')}} 2x" src="{{asset('themes/default/images/products/product1-1.jpg')}}" alt=""></a>
                                        @endif
                                    </div>
                                    <div class="product-card__info">
                                                    ...
                                                    <div class="rating__body">
                                                        <svg class="rating__star rating__star--active" width="13px" height="12px">
                                                            <g class="rating__fill">
                                                                <use xlink:href="{{asset('themes/default/images/sprite.svg#star-normal')}}"></use>
                                                            </g>
                                                            <g class="rating__stroke">
                                                                <use xlink:href="{{asset('themes/default/images/sprite.svg#star-normal-stroke')}}"></use>
                                                            </g>
                                                        </svg>
                                                        <svg class="rating__star rating__star--active" width="13px" height="12px">
                                                            <g class="rating__fill">
                                        ...
                                        <div class="product-card__buttons">
                                            <div class="product-card__buttons-list">
                                                ...
                                                <button class="btn btn-light btn-svg-icon product-card__wishlist" data-add-wishlist="true" data-product-id="{{$prod->id}}" type="button">
                                                    <svg width="16px" height="16px">
                    ...
                    {{$productos->appends(['view_list'=>$view_list,'price_min'=>$price_min,'price_max'=>$price_max,'new'=>$new,'offer'=>$offer])->links('theme_default.pagination.default',['shop'=>$shop])}}
