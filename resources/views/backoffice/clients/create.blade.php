                ...
                <form id="form-wizard" method="post" action="{{route('clients.store')}}" novalidate="novalidate">
                    ...
                    <section>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control required" id="birthdate" type="date" name="birthdate" value="{{old('birthdate')}}">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Ciudad</label>
                            <input class="form-control required" id="city" type="text" name="city" value="{{old('city')}}">
                        </div>
                        <div class="form-group">
                    ...
                    <section>
                        <div class="text-center">
                            <h3>¡Enhorabuena!</h3>
                            <p>La cuenta sera creada con los siguientes datos:</p>
                            <div class="form-group">
                                <label> Usuario :</label>
                                <div class="input-group-icon input-group-icon-left input-group-icon-right">
                                    <span class="input-icon input-icon-left"><i class="ti-user"></i></span>
                                    <input class="form-control" name="username" id="username" readonly="true" type="text" placeholder="Usuario">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-icon input-group-icon-left input-group-icon-right">
                                    ...
                                    <input class="form-control" name="password" id="password" readonly="true" type="text" placeholder="Clave">
                                </div>
                            </div>
                        </div>
                    </section>
        ...
        $(function() {
            $('#form-wizard').steps({
                ...
                onStepChanging: function(event, currentIndex, newIndex) {
                    ...
                    if(currentIndex<2){
                        $("#username").val($("#code").val());
                        $("#password").val($("#code").val()+Math.random().toString(36).substring(4,6));
                    }
