...
<html lang="es">
<head>
    @include('backoffice.partials.admin2._header')

</head>
<body class="boxed-layout">
<div class="page-wrapper">
    @include('backoffice.partials.admin2._menu')

    <div class="wrapper content-wrapper">
        @yield('content')

        <footer class="page-footer">
            <div class="font-13">2022 © <b>Renatto V.</b> - Todos los derechos reservados</div>
            <div>
                <a class="px-3 pl-4" href="https://instagram.com" target="_blank">Instagram</a>
                <a class="px-3" href="https://facebook.com" target="_blank">Facebook</a>
            </div>
...
<!-- START SEARCH PANEL-->
<form class="search-top-bar" method="get" action="{{route('shop.shop',['code' => session('shop_code')])}}">
    <input class="form-control search-input" name="q" id="q" type="text" placeholder="Escribe un producto...">
    ...
    <div class="theme-config-box">
        ...
        <div class="check-list mb-4">
            <label class="radio radio-grey radio-primary">
                <input type="radio" name="layout-style" value="">
                <span class="input-span"></span>Fluid</label>
            <label class="radio radio-grey radio-primary mt-3">
                <input type="radio" name="layout-style" value="1" checked>
                <span class="input-span"></span>Boxed</label>
        </div>
        <div class="mt-4 mb-2 font-strong">THEME COLORS</div>
        <div>
                ...
                <div class="scroller">
                    <div class="media-list">
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u3.jpg')}}" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u8.jpg')}}" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u2.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u5.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u6.jpg')}}" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u11.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u9.jpg')}}" alt="image" width="40" />
                            </div>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u1.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u10.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <a class="media" href="javascript:;" data-toggle="show-chat">
                            <div class="media-img">
                                <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u7.jpg')}}" alt="image" width="40" />
                            </div>
                            <div class="media-body"><small class="float-right text-muted">12:05</small>
                    ...
                    <div class="scroller">
                        <div class="messenger-message">
                            <div class="message-image">
                                <img src="{{asset('themes/adminca-8/img/users/u8.jpg')}}" alt="image" />
                            </div>
                        ...
                        <div class="messenger-message">
                            ...
                            <div class="message-body">
                                ...
                                <div class="mb-3">
                                    <img src="{{asset('themes/adminca-8/img/blog/culinary-1.jpeg')}}" alt="image" />
                                </div>
                                <div>
                                    <img src="{{asset('themes/adminca-8/img/blog/01.jpeg')}}" alt="image" />
                                </div>
                            </div>
                        </div>
                        <div class="messenger-message messenger-message-answer">
...
@include('backoffice.partials.admin2._footer')
@stack('after_scripts')
</body>
</html>
