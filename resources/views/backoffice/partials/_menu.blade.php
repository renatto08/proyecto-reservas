    ...
    <div class="header-topbar">
        <div class="wrapper d-flex">
            <div class="page-brand">
                <a class="link" href="{{route('b.dashboard')}}">
                            <span class="brand">Tienda
                                <span class="brand-tip">Pe</span>
                            </span>
                </a>
            </div>
                ...
                <ul class="nav navbar-toolbar">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                            ...
                            <div class="p-3">
                                <div class="media-list media-list-divider scroller" data-height="350px" data-color="#71808f">
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u8.jpg') }}" alt="image" />
                                        </div>
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u6.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u11.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u10.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u2.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u5.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <a class="media p-3">
                                        <div class="media-img">
                                            <img class="img-circle" src="{{asset('themes/adminca-8/img/users/u9.jpg') }}" alt="image" />
                                        </div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            ...
                            <img src="{{asset('themes/adminca-8/img/users/admin-image.png')}}" alt="image" />
                        </a>
                        <div class="dropdown-menu dropdown-arrow dropdown-menu-right admin-dropdown-menu">
                            ...
                            <div class="admin-menu-content">
                                <div class="text-muted mb-2">Tu Billetera</div>
                                <div><i class="ti-wallet h1 mr-3 text-light"></i>
                                    <span class="h1 text-success"><sup>$</sup>12.7k</span>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <a class="text-muted" href="javascript:;">Historia de ventas</a>
        ...
        <div class="wrapper" id="navbar-wrapper">
            <ul class="nav-menu">
                <li class="dropdown active">
                    <a class="dropdown-toggle" href="href=&quot;javascript:;" data-toggle="dropdown">Dashboards
                        <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{route('b.dashboard')}}">Ventas & Reservas</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" href="href=&quot;javascript:;" data-toggle="dropdown">Operaciones
                        <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{route('orders.index')}}">Reservas</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{route('b.inventary.index')}}">Inventario</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{route('orders.received',['status'=>'Venta','parent'=>'me'])}}">Mis ventas</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a class="dropdown-toggle" href="href=&quot;javascript:;" data-toggle="dropdown">Administrativo
                        <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{route('orders.received')}}">Reservas Recibidas</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{route('orders.create_sell')}}">Generar Venta</a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{route('orders.received',['status'=>'Venta'])}}">Ventas</a>
                        </li>

                    </ul>
                </li>
                <li>
                    <a class="dropdown-item" href="{{route('shop.redirect',['id'=>Session::get('shop_id')])}}">Ver Tienda</a>
                </li>
