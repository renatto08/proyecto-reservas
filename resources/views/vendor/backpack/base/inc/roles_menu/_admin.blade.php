...
<!--
class="fa fa-dashboard nav-icon"
class="nav-icon fa fa-files-o"
-->
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('color') }}'><i class='fa fa-dashboard nav-icon'></i> Colores</a></li>
